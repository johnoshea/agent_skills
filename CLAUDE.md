...
Personal skills that load in both Claude Code and Codex. README.md lists the prerequisites and says how the skills are installed and added.
...
- A skill serves both hosts from one `SKILL.md`. Write host-specific steps as "in Claude Code, X; in Codex, Y" inside the procedure, the way [johns-way](https://github.com/johnoshea/johns-way) does.
